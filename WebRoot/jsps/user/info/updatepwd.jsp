...
<script type="text/javascript" src="<%=request.getContextPath()%>/jsps/js/user/updatepassword.js"></script>
<style type="text/css">
body {
	padding-top: 40px;
	padding-bottom: 40px;
...
.labelError1{line-height: 9px; font-size: 10pt; color: #f40000; border: 1px #ffb8b8 solid; padding: 8px 8px 8px 35px; background: url(/Shopping/image/error.png) no-repeat; background-color: #fef2f2;}
</style>
</head>
<body>
   <form action="user!updatePassword.action" class="form-signin"  method="post"  onsubmit="return check();">
         <h2 class="form-signin-heading">修改密码</h2>
 			<table >
            	<tr>
            	<td>原密码:</td>
            	<td ><input type="password" name="oldpassword" id="oldpassword" class="input"></td>
            	<td><label class="labelError1" id="oldpasswordError"> </label></td>
            	</tr>
