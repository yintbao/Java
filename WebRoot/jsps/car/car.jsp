<%@ page language="java" contentType="text/html; charset=UTF-8" import="java.util.*,com.inspur.model.*"
	pageEncoding="UTF-8"%>
<%
	//获取session
		...
		<tbody>
		  ...
		  %>
			...
			<tr>
				...
				<td><a href="${pageContext.request.contextPath}/goods!deleteCar.action?deletegoodid=<%=((Goods)map.get("goods")).getId() %>" class="btn btn-primary" style="height:23px;color:#fff;">删 除</a></td>
			</tr>
			<%}%>
		</tbody>
		 <% int total=0;
		...
		<tfoot>
			...
			<tr>
				<td colspan="7" align="right" style="text-align:right;">
					<a href="javascript:history.back(-1)" class="btn btn-primary" style="height:22px;color:#fff;">返回商品列表</a>&nbsp;&nbsp;&nbsp;
					<a href="${pageContext.request.contextPath}/jsps/order/order_ok.jsp" class="btn btn-primary" style="height:22px;color:#fff;">去结算</a>
				</td>
			</tr>
		</tfoot>
	</table>
